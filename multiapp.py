...
Copied from: https://github.com/giswqs/streamlit-geospatial/blob/master/multiapp.py
"""
...
class MultiApp:
    ...
    def run(self):
        ...
        default_selectbox = titles.index(app_state["page"]) if "page" in app_state else 0

        st.sidebar.title("Navigation")

        title = st.sidebar.selectbox("Go To", titles, index=default_selectbox, key="radio")
        ...
        st.sidebar.info(
            """
            This web [app](https://github.com/ELROSTEM/shoreline-reconfiguration) is maintained by [ELROSTEM](https://github.com/ELROSTEM) in [ERHS](https://www.erhsnyc.org/)
